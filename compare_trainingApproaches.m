...
xlim([0 14000]); ylim([0 25000]);
plot(1:max(xlim)/10:max(xlim), 1:max(ylim)/10:max(ylim), 'k')
legend({'iter-1000', 'iter-1500', 'iter-2000'}, 'Location', 'northwest')
legend box off
...
denoised_train001_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train001-iter1000/dwi.nii.gz'));
denoised_train001_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train001-iter1000/dwi.nii.gz'));
denoised_train001_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train001-iter1000/dwi.nii.gz'));
denoised_train001_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train001-iter1000/dwi.nii.gz'));

% Read in the sos-denoised data trained with sub-002.
denoised_train002_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train002-iter1000/dwi.nii.gz'));
denoised_train002_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train002-iter1000/dwi.nii.gz'));
denoised_train002_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train002-iter1000/dwi.nii.gz'));
denoised_train002_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train002-iter1000/dwi.nii.gz'));

% Read in the sos-denoised data trained with sub-003.
denoised_train003_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train003-iter1000/dwi.nii.gz'));
denoised_train003_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train003-iter1000/dwi.nii.gz'));
denoised_train003_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train003-iter1000/dwi.nii.gz'));
denoised_train003_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train003-iter1000/dwi.nii.gz'));

% Read in the sos-denoised data trained with sub-004.
denoised_train004_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train004-iter1000/dwi.nii.gz'));
denoised_train004_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train004-iter1000/dwi.nii.gz'));
denoised_train004_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train004-iter1000/dwi.nii.gz'));
denoised_train004_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train004-iter1000/dwi.nii.gz'));
...
title('sos-denoised and sos-denoised correlations, sense thresholded')
pbaspect([1 1 1])
box off 

% Save figure.
% print(fullfile(rootDir, 'plots', 'plot_corrmat_sensethresholded'), '-dpng')
...
denoised_train001002003_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train001002003-iter1000/dwi.nii.gz'));
denoised_train001002003_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train001002003-iter1000/dwi.nii.gz'));
denoised_train001002003_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train001002003-iter1000/dwi.nii.gz'));
denoised_train001002003_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train001002003-iter1000/dwi.nii.gz'));
...
denoised_train001002003004_sub001 = niftiRead(fullfile(rootDir, blprojectid, 'sub-001/denoised-first-APPAb0-train001002003004-iter1000/dwi.nii.gz'));
denoised_train001002003004_sub002 = niftiRead(fullfile(rootDir, blprojectid, 'sub-002/denoised-first-APPAb0-train001002003004-iter1000/dwi.nii.gz'));
denoised_train001002003004_sub003 = niftiRead(fullfile(rootDir, blprojectid, 'sub-003/denoised-first-APPAb0-train001002003004-iter1000/dwi.nii.gz'));
denoised_train001002003004_sub004 = niftiRead(fullfile(rootDir, blprojectid, 'sub-004/denoised-first-APPAb0-train001002003004-iter1000/dwi.nii.gz'));
